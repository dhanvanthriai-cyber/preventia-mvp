...
- `eng/src/main/java/com/preventia/clinical/scheduler/PrescriptionSlaScheduler.java` (notify on SLA breach)
- `eng/src/main/java/com/preventia/appointment/service/AppointmentService.java` (notify 24h before)
...
- [ ] All migrations: `podman exec preventia-postgres psql -U dhan_dev -d preventia_db -c "SELECT version, description FROM flyway_schema_history ORDER BY installed_rank;"`
