...
**Project Preventia MVP · Spring Boot 3.2 / Java 21 / PostgreSQL 16**
...
`docker-compose.yml` is now the **canonical local development environment** for Project Preventia.
