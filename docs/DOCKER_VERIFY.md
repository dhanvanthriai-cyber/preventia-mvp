# Podman Setup — Project Preventia
...
|----------|-------|-----------------------|
| Spring Boot API | 8080 | preventia-app  |
| PostgreSQL 16   | 5432 | preventia-postgres |
| Redis 7         | 6379 | preventia-redis    |
...
podman exec -it preventia-postgres psql -U dhan_dev -d preventia_db
```
