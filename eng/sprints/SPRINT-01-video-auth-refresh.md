...
**Rules:**
- `middleware.ts` — protect `/doctor`, `/pharmacist`, `/sponsor` routes; redirect to `/login` if no JWT cookie named `dhanvanthri_token`
...
- `eng/src/main/java/com/dhanvanthri/auth/dto/RefreshRequest.java`
- `eng/src/main/java/com/dhanvanthri/auth/dto/RefreshResponse.java`
